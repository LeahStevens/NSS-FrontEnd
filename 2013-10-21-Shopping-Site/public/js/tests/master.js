...
test('Add Orders to Database and Order Table', function(){
  expect(14);
  ...
  equal($('#cart tbody tr').length, 0, 'should have 0 rows in tbody after purchase');
  ...
  equal($('#orders tbody .order-time').text().split(' ').length, 5, 'date time should be formatting correctly');
